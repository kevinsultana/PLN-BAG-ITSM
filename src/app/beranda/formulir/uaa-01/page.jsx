...
export default function Page() {
  ...
  const captureCanvas = async (node) => {
    // handle elemen scrollable biar kebuka semua
    const scrollables = node.querySelectorAll(".max-h-80.overflow-y-auto");
    const originals = [];
    ...
    // restore scrollables
    originals.forEach(({ el, overflow, maxHeight, height }) => {
      el.style.overflow = overflow || "auto";
      el.style.maxHeight = maxHeight || "20rem";
  ...
  const handleExportPdf = async (e) => {
    ...
    pdf.save("form-uaa-01.pdf");
  };

  return (
    <div style={{ backgroundColor: "#f1f5f9", minHeight: "100vh" }}>
      <MainLayout>
        {/* Global styles agar konsisten dan tajam */}
        <style jsx global>{`
          .print-sheet {
            width: ${A4_W}px; /* kunci lebar A4 */
            margin: 0 auto;
            background: #fff;
          }
          table,
          ...
          * {
          ...
          /* gaya input normal saat user mengisi (bukan saat capture) */
          input,
          textarea,
          select {
            appearance: none;
            ...
            >
              ...
              >
                <div>
                  ...
                  <p style={{ fontWeight: 600 }}>UAA-01</p>
                </div>
                ...
                <img
                  src="/logoNavbar.png" // simpan di /public
                  alt="logo"
                  width={127}
                  height={44}
