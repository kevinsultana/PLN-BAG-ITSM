...
export default function ErpHcmTable() {
  const formList = [
    {
      id: 1,
      name: "User Matrix ERP HCM",
    },
    {
      id: 2,
      name: "Dokumen Konfigurasi ERP HCM",
    },
    {
      id: 3,
      name: "Dokumen SOP ERP HCM",
    },
    {
      id: 4,
      name: "Dokumen Shipment ERP HCM",
    },
  ];
          ...
          <table className="table-fixed w-full text-left border border-gray-200 rounded-xl overflow-hidden shadow">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-3">ERP HCM</th>
