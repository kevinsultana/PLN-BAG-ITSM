...
export default function FuelMentoringTable() {
  const formList = [
    {
      id: 1,
      name: "User Matrix Fuel Mentoring",
    },
    {
      id: 2,
      name: "Dokumen Konfigurasi Fuel Mentoring",
    },
    {
      id: 3,
      name: "Dokumen SOP Fuel Mentoring",
    },
    {
      id: 4,
      name: "Dokumen Shipment Fuel Mentoring",
    },
  ];
          ...
          <table className="table-fixed w-full text-left border border-gray-200 rounded-xl overflow-hidden shadow">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-3">Fuel Mentoring</th>
