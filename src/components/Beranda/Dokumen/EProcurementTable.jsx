...
export default function EProcurementTable() {
  const formList = [
    {
      id: 1,
      name: "User Matrix E-Procurement",
    },
    {
      id: 2,
      name: "Dokumen Konfigurasi E-Procurement",
    },
    {
      id: 3,
      name: "Dokumen SOP E-Procurement",
    },
    {
      id: 4,
      name: "Dokumen Shipment E-Procurement",
    },
  ];
          ...
          <table className="table-fixed w-full text-left border border-gray-200 rounded-xl overflow-hidden shadow">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-3">E-Procurement</th>
