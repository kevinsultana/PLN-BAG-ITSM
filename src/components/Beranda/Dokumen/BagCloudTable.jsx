...
export default function BagCloudTable() {
  const formList = [
    {
      id: 1,
      name: "User Matrix Bag Cloud",
    },
    {
      id: 2,
      name: "Dokumen Konfigurasi Bag Cloud",
    },
    {
      id: 3,
      name: "Dokumen SOP Bag Cloud",
    },
    {
      id: 4,
      name: "Dokumen Shipment Bag Cloud",
    },
  ];
          ...
          <table className="table-fixed w-full text-left border border-gray-200 rounded-xl overflow-hidden shadow">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-3">Bag Cloud</th>
